...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2022 at 11:20 PM
...
--
-- Table structure for table `signedin_admin`
--

CREATE TABLE `signedin_admin` (
...
INSERT INTO `students` (`id`, `student_name`, `email`, `password`, `phone`, `address`, `college`, `created_at`, `Token`, `is_verified`) VALUES
(1, 'ahmed', 'ahmed@gmail.com', '', '01013769931', 'cairo', 'BIS', '2022-04-06 18:05:16', '', b'0'),
(2, 'ging', 'ging@gmail.com', '', '01013769931', 'Zamalek', 'FMI', '2022-04-06 18:05:16', '', b'0'),
(4, 'HISOKA', 'ahmedmoyousry.bis@gmail.com', '$2y$10$gUCXiJvsHQ2iRLOGrjFg4uQrOoMvsY/EHUt9SJgLHk/2ez35OASZG', '0101376', 'Haram', 'BIS', '2022-04-07 00:15:51', '', b'0');
...
--
-- Indexes for table `signedin_admin`
--
ALTER TABLE `signedin_admin`
...
--
-- AUTO_INCREMENT for table `signedin_admin`
--
ALTER TABLE `signedin_admin`
